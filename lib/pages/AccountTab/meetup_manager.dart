...
class MeetupManager extends StatefulWidget {
  const MeetupManager({Key? key}) : super(key: key);

  @override
  State<MeetupManager> createState() => _MeetupManagerState();
}

class _MeetupManagerState extends State<MeetupManager> {
  @override
