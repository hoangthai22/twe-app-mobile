...
class MySessionPageWaiteLocation extends StatefulWidget {
  const MySessionPageWaiteLocation({Key? key}) : super(key: key);

  @override
  State<MySessionPageWaiteLocation> createState() => _MeetupManagerState();
}

class _MeetupManagerState extends State<MySessionPageWaiteLocation> {
  @override
                ...
                children: [
                  Container(
                    ...
                    child: FlatButton(
                      ...
                      color: Color.fromARGB(255, 74, 197, 89),
